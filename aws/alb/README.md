...
Original file: https://github.com/boltops-learn/kubernetes-examples/blob/master/aws/alb/README.md
...
2. [service](service.yaml): Expose an endpoint to reach the nginx pods. This service creates an AWS Application Load Balancer.
...
[![Watch the video](https://uploads-learn.boltops.com/yrmsr8n4sh2wa57gdd86lwpvq26p)](https://learn.boltops.com/courses/aws-eks/lessons/eks-aws-application-load-balancer-with-ingress-resource)
